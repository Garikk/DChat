...
Module Chat
    ...
    Public Sub DCB_ShowMessage(ByVal User As UNI_Plugin.UNI_DChat.DCB_V1.DCB_Channels2.DCB_User, ByVal MsgType As UNI_Plugin.UNI_DChat.DCB_V1.DCB_Base.DCB_MessageTypes, ByVal Msg As String, ByVal ToChannel As UNI_Plugin.UNI_DChat.DCB_V1.DCB_Channels2.DCB_Channel, ByVal MyColor As UNI_Plugin.UNI_DChat.DCB_V1.DCB_Base.DCB_IRCColors, Optional ByVal UPDIcon As Byte = 1)
