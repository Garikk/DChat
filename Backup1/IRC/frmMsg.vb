...
#Region "Windows Form Designer generated code "
    Public Sub New(ByVal ToUsr As String, ByVal Mode As QuickMsgInitTypes, Optional ByVal RtfDef As String = "")
        ...
        iToUsr = ToUsr
        iMode = Mode
        RtfDef = RtfDef.Replace(Chr(1), vbLf)
        txtMessage.Rtf = DC2Conv.dc2toRTF(RtfDef, IRC_Settings.IRCFont, CStr(IRC_Settings.IRCFontSize))
        MaxLen = 500 - (iToUsr.Length + 17)
        lblMsgInfo.Text = CStr(txtMessage.TextLength) & "/" & MaxLen
        Select Case Mode
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdPrivat.FlatStyle = System.Windows.Forms.FlatStyle.System
        ...
        Me.cmdCit.FlatStyle = System.Windows.Forms.FlatStyle.System
        ...
        Me.cmdAnswer.FlatStyle = System.Windows.Forms.FlatStyle.System
...
#End Region
    ...
    Private Sub cmdAnswer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAnswer.Click
        Select Case iMode
            Case QuickMsgInitTypes.QW_NEW_ONE
                Dim TTS As String = DC2Conv.RTFToDC2(txtMessage.Rtf)
                TTS = TTS.Replace(vbCrLf, Chr(1))
                TTS = TTS.Replace(vbLf, Chr(1))
                DCSE.ExecScriptCommand(IRC_INF.INF_CMDEXEC, "qwm_$quickmsg$ " & iToUsr & " [QMSG] " & TTS)
    ...
    Private Sub txtMessage_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtMessage.KeyDown
        If e.Control = True And e.KeyCode = Windows.Forms.Keys.Enter Then
            e.Handled = True
            cmdAnswer_Click(Me, New EventArgs)
        ElseIf e.Control = True And e.KeyCode = Windows.Forms.Keys.Back Then
            txtMessage.Text = UNI_Plugin.UNI_DChat.DCB_Universal.ChangeRLLayout.ChangeLayout(txtMessage.Text)
    ...
    Private Sub cmdPrivat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrivat.Click
        DCSE.ExecScriptCommand(IRC_INF.INF_CMDEXEC, "%PID% irc_createprivate " & iToUsr)
        Me.Close()
    End Sub
End Class