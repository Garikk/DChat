...
#End Region
    ...
    Private Sub tlbColors_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles tlbColors.ButtonClick
        ...
        Select Case e.Button.Tag
            ...
            Case 1 To 16
                txtRTFTxt.SelectionColor = Color.FromArgb(DCB_Interface.DCB_Universal.DC2Converter.GetARGBfromIRCCode(CInt(e.Button.Tag) - 1))
                '    txtRTFTxt.Rtf = DCB_Interface.DCB_Universal.DC2Converter.ReplClrTbl(txtRTFTxt.Rtf)
                SetFontParams(txtRTFTxt, cmdBold.Pushed, False, cmdUnderline.Pushed)
        End Select
    End Sub
    ...
    Private Sub txtRTFTxt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtRTFTxt.TextChanged
        If cmdCopy.Visible = True Then
            txtmIRCTxt.Text = DCB_Interface.DCB_Universal.DC2Converter.RTFToDC2(txtRTFTxt.Rtf)
        End If
    End Sub
    ...
    Private Sub lblRTF_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblRTF.Click
